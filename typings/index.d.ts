...
declare module 'discord.js' {
  ...
  export class Guild extends Base {
    ...
    public createCommand(command: ApplicationCommand): ApplicationCommand;
  ...
  export class InteractionClient extends BaseClient {
    ...
    public token: string;
    public createCommand(command: ApplicationCommand, guildID?: Snowflake): ApplicationCommand;
    public fetchCommands(guildID?: Snowflake): ApplicationCommand[];
    public middleware(): (req: object, res: object) => void;

    public on<K extends keyof InteractionClientEvents>(
      event: K,
      listener: (...args: InteractionClientEvents[K]) => void,
    ): this;
    public on<S extends string | symbol>(
    ...
    public once<K extends keyof InteractionClientEvents>(
      event: K,
      listener: (...args: InteractionClientEvents[K]) => void,
    ): this;
    public once<S extends string | symbol>(
    ...
    public off<K extends keyof InteractionClientEvents>(
      event: K,
      listener: (...args: InteractionClientEvents[K]) => void,
    ): this;
    public off<S extends string | symbol>(
